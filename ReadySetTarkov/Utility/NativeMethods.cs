...
public class NativeMethods : INativeMethods
{
    ...
    public uint GetTarkovProcId() => s_tarkWindow == IntPtr.Zero ? 0 : _user32.GetWindowThreadProcessId(s_tarkWindow);
    ...
    public void BringTarkovToForeground()
    {
        ...
        _ = _user32.SetWindowPos(tHandle, HWND_TOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        _ = _user32.SetWindowPos(tHandle, HWND_NOTOPMOST, 0, 0, 0, 0, TOPMOST_FLAGS);
        _ = _user32.SetForegroundWindow(tHandle);
        _ = _user32.SetFocus(tHandle);
        _ = _user32.SetActiveWindow(tHandle);
    }
